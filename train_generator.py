...
def main():
    ...
    if not os.path.exists(args['results__dir']):
        ...
        if args['mode'] == "export":
            ...
            tf.add_to_collection("outputs", json.dumps(inputs))
            outputs = {
        ...
        with tf.name_scope("convert_outputs images"):
        ...
        with tf.name_scope("encode_images"):
            display_fetches = {
                ...
                "targets": tf.map_fn(tf.image.encode_jpeg, converted_target_images, dtype=tf.string, name="input_jpgs"),
                "outputs":tf.map_fn(tf.image.encode_jpeg, converted_output_images, dtype=tf.string, name="input_jpgs"),
            }
        ...
        for grad, var in model.discrim_grads_vars + model.gen_grads_vars:
            ...
            with sv.managed_session() as sess:
                ...
                if args['mode'] == "test":
                    ...
                    for step in range(max_steps):
                        ...
                        filesets = ds.save_image(results)
                    ...
                    for step in range(max_steps):
                        ...
                        if right_time(args['display_freq']):
                            ...
                            filesets = ds.save_image(results["display"], step=results["global_step"])
